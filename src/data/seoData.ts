...
export const SEO_DATA: Record<string, SEOMetadata> = {
  home: {
    title: 'Flynn James — Senior B2B SDR & Appointment Setting Specialist',
    ...
    ogImage: DEFAULT_OG,
    ogType: 'website',
    keywords: ['B2B SDR', 'appointment setting', 'cold calling specialist', 'outbound sales development', 'fractional sales rep'],
  },
  about: {
    title: 'About Flynn James — 11+ Years in B2B Outbound Sales',
    description: 'Eleven years of outbound sales experience across SaaS, IT, and digital agencies. Learn how Flynn builds predictable pipelines for B2B teams worldwide.',
  ...
  services: {
    ...
    description: 'Six focused outbound services: appointment setting, cold calling, lead generation, SDR coaching, LinkedIn outreach, and CRM pipeline management.',
  ...
  experience: {
    ...
    description: 'Documented track record across Regen Digital US, Seek Marketing, Averps, Public Sector Network, and Pacific Outsource. Consistent 120–150% quota attainment.',
    canonical: `${SITE_URL}/experience`,
    ogImage: DEFAULT_OG,
  },
  'case-studies': {
    title: 'B2B Sales Case Studies — $1.8M+ Pipeline Sourced',
    description: 'Detailed outbound sales case studies showing $1.8M+ pipeline generated, 120% quota attainment, and 30+ qualified meetings booked monthly.',
    canonical: `${SITE_URL}/case-studies`,
    ogImage: DEFAULT_OG,
  },
  samples: {
    title: 'Sales Playbooks & Cold Call Scripts — Flynn James',
    description: 'The exact cold call scripts, 7-touch cadences, BANT scorecards, and AE handoff templates used to generate $1.8M+ pipeline.',
