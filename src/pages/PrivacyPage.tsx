      ...
      <Section>
        <article className="max-w-3xl space-y-8 text-[14.5px] text-slate-300 leading-[1.8]">
          <div>
            ...
            <p>This site is a personal portfolio for B2B sales services provided by Flynn James Q. Pontino. I collect the absolute minimum amount of data required to respond to inquiries and schedule calls. Nothing more.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>Submitted information is used only to respond to your inquiry or confirm a scheduled call. It is never sold, shared, or used for unsolicited marketing purposes.</p>
          </div>
          <div>
            <h2 className="text-[22px] font-bold text-white mb-4">Your rights</h2>
            <p>You can request deletion of any data submitted through this site at any time by emailing <a href="mailto:va.flynnjames@gmail.com" className="text-amber-400 hover:underline">va.flynnjames@gmail.com</a>.</p>
          </div>
        </article>
      </Section>
    </>
